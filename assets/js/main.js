...
const translations = {
    'en': {
      ...
      'portfolio.description1': "An online manga store created as my college thesis. <br> PHP | MySQL | Webhook | JS | CSS | API",
    ...
    'portfolio.title1': "Honkai",
    'portfolio.description1': "Uma loja de mangás online criada como meu TCC para a faculdade. <br> PHP | MySQL | Webhook | JS | CSS | API",
  ...
  'ja': {
    ...
    'portfolio.title1': "Honkai",
    'portfolio.description1': "大学の卒業プロジェクトとして作成したオンライン漫画ストア。<br> PHP | MySQL | Webhook | JS | CSS | API",
